...
// Optimistic auth checks only (per the Next.js auth guide) — the secure,
// role-aware checks live in the data access layer (features/auth/session.ts).
// This also refreshes expired Supabase sessions so server components always
// see a valid token.
